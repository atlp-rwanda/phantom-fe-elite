...
// import AsideUserOnPhone from "./TemplateComponent/AsideUserOnPhone";
...
const UserView = () => {
  ...
  return (
    <div className="grid h-screen w-screen overflow-x-hidden grid-cols-12 grid-rows-12 font-Nunito bg-[#f3f3f3] overflow-y-hidden">
      ...
      <main className="flex flex-col col-start-1 sm:col-start-4 md:col-start-5 lg:col-start-4 col-end-13 row-start-2 sm:row-start-3 row-end-13 bg-red-800">
