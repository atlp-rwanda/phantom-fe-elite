...
const UserChooseRoutes = () => {
  ...
  <div className="grid h-screen w-screen overflow-x-hidden grid-cols-12 grid-rows-16 font-Nunito bg-[#f3f3f3] overflow-y-hidden">
    <HeaderUserPlan />
    <main className="flex z-0 flex-col col-start-4 col-end-13 row-start-3 row-end-13 bg-red-800 md:col-start-6 lg:col-start-4 hidden md:block lg:block" data-testid = "map-render">
