...
const AsideUser = () => {
  return (
    <aside className="bg-[#f3f3f3] sm:col-start-1 sm:col-end-4 md:col-end-5 lg:col-end-4 hidden sm:block text-black row-start-3 row-end-17 border-r-2 border-solid border-[#f3f3f3]">
      <label
        htmlFor="email"
      ...
      <section className="w-[95%] h-2/5 mx-auto mt-3 mb-1 bg-white overflow-auto">
