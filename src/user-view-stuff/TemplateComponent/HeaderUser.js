...
const HeaderUser = ({ setAsideOpen }) => {
  return (
    <header
      id="header-user-view"
      className="bg-white col-start-1 sm:col-start-3 md:col-start-4 border-solid border-b-4 shadow border-adminFooterBackground lg:col-start-1 col-end-13  row-start-1 row-end-2 sm:row-end-3"
    >
      <section className="w-full flex justify-between items-center h-full px-3 sm:px-10">
        ...
        <form action="" className="hidden sm:block w-2/5 h-7 mx-12">
          <input
            type="text"
            placeholder="Search"
        ...
        <div className="flex justify-around w-3/4 sm:w-1/5 items-center h-full">
