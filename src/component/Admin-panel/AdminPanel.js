	...
	return (
		<div className="grid h-screen w-screen grid-cols-12 grid-rows-12 font-Nunito bg-[#f3f3f3]">
			...
			<main className=" flex flex-col col-start-3 col-end-13 row-start-2 row-end-12 px-3 mx-2 mt-2 bg-white">
				{children}
        <div className="bg-third-text4 py-36">
        <h1>Hello We are Here</h1>
        <div>
          <img src={ImageMap} alt="image Route"></img>
        </div>
...
// import React from "react";
// import Records from "../../component/Admin-panel/data/data.json";

// function AdminPanel() {
//   return (
//     <div className="bg-third-text4">
//       {Records &&
//         Records.map((record) => {
//           return (
//             <div
//               key={record.id}
//               className="bg-third-inputgray flex flex-col gap-2"
//             >
//               <h1>Hello from admin pannel</h1>
//               <div>
//                 <h2>
//                   {record.category}{" "}
//                   <span className="px-2">{record.caption}</span>
//                 </h2>
//               </div>
//               <div className="flex gap-4">
//                 <div>
//                   <img src={record.icon} alt="busesImage"></img>
//                 </div>
//                 <div>
//                   {" "}
//                   <p className="text-4xl px-5">{record.number}</p>
//                 </div>
//               </div>
//             </div>
//           );
