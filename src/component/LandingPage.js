    ...
    <>
      <main>
        ...
        >
          ...
          <div>
            <h1 className="text-sky-600 leading-9 text-4xl">
              Track bus movements
            </h1>
        ...
        {/* className = .title-and-image */}
        <section className="flex justify-around items-center mx-0 mt-8 mb-16">
          <button className=" w-72 h-12 text-white rounded-3xl p-0 cursor-pointer border-none bg-sky-600">
            See for yourself
          </button>
          <input
