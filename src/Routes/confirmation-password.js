                  ...
                  <form className="mx-8 relative" onSubmit={handleSubmit()} >
                    <div className="">
                      <input
                        ...
                        className={`npassword w-full px-4 py-2 text-sm leading-tight text-gray-700 border mt-12  mb-3  border-textBluePhant rounded ${errors.password && 'focus:border-errorText focus:ring-errorText border-errorText'}`}
                      ...
                      />
                      {errors.password && <span className="text-sm text-errorText " data-testid="error-msg">{errors.password.message}</span>}
                      <input
                         role='pass'
                        className={`npassword w-full px-4 py-2 text-sm leading-tight text-gray-700 border mt-3  mb-3  border-textBluePhant rounded  ${errors.ConfirmPassword && 'focus:border-errorText focus:ring-errorText border-errorText'}`}
                      ...
                      />
                      <div className="">
                     {errors.ConfirmPassword && <span className="text-sm text-errorText " data-testid="error-msg">{errors.ConfirmPassword.message}</span>}
                      </div>
                    </div>
                    <button
