...
function BusRoutedata() {
  return (
    <div className="bg-white px-4 rounded-lg">
      <div className="my-2  font-black text-xl border-b-2 border-solid border-darkBluePhant w-[200px]">
        Bus , Routes Data
      </div>
      ...
      <div className="grid grid-cols-12 border-b-2 border-gray-400 font-bold border-solid">
        ...
        <div className="col-span-2 pt-3 text-xs font-medium">
          Near Gishubi Bus Stop
        </div>
